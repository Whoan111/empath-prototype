...
export const TRANSLATIONS = {
  en: {
    ...
    navDecisionBriefs:'Decision Briefs',
    navDebriefs:     'Post-interview Debriefs',
  ...
  it: {
    ...
    navSummaries:    'Riepiloghi Colloqui',
    navInsights:     'Analisi AI',
    navMyDashboard:  'La Mia Bacheca',
    navDecisionBriefs:'Brief Decisioni',
    navDebriefs:     'Debriefing Post-Colloquio',
